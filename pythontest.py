...
'''
cipherstring = "IAAAAEkQBhEVBwpDHAFJGhYHSBYEGgocAw=="
cipher_text = base64.b64decode(cipherstring)

text = "This crypto is not strong"
I = "".join(chr(ord(a)^ord(b)) for a,b in zip(cipher_text,text))
...
integer = 1
while integer < 100:
    encode_this = "0000000000000" + to_string(integer)
